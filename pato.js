...
//Welkom
			...
			teks += `╔═══•ೋೋ•═══╗\n`
            teks += `➣ LIGHT⚡𝐁𝐎𝐓 😎 úsalo en tus grupos👇🏻 https://youtube.com/channel/UCqiXnIA8_K83MqHtnyMzR2A?sub_confirmatión=1\n`
            teks += `╚═[-LIGHT☬𝐍𝐓𝐑.li ]═╝\n`
...
　        teks += ` .　ﾟ • ﾟ   •　。ﾟ    • ඞ   。　ﾟ .\n`
            teks += ` @${num.split('@')[0]} 🐈💨\n`
            teks += `╔═══•ೋೋ•═══╗\n`
      　  teks += `LIGHT⚡𝐁𝐎𝐓 😎 úsalo en tus grupos👇🏻 https://youtube.com/channel/UC55uJfxI_YtCPztltcsgsjA?sub_confirmatión=1\n`
            teks += `╚═[-LIGHT☬𝐍𝐓𝐑.li ]═╝\n`
			let buff = await getBuffer(ppimg)
			turbo.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
...
𝐇𝐨𝐥𝐚 ${pushname} 𝐛𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝o 𝐚𝐥 𝐦𝐞𝐧𝐮🥵
╭────•••◈•••───╮
LIGHT⚡BOT 👇🏻: https://youtube.com/channel/UC55uJfxI_YtCPztltcsgsjA?sub_confirmatión=1
✦⏝࣪꒷꒦꒦꒷꒦⏝⏝꒦꒷✦
MI IG  https://www.instagram.com/light___fx5
LIGHT 𝐈𝐧𝐟𝐨
✪➣ ${prefix}𝐜𝐚𝐧𝐚𝐥
✪➣ ${prefix}𝐜𝐫𝐞𝐚𝐝𝐨𝐫
✪➣ ${prefix}𝐫𝐞𝐠𝐥𝐚𝐬
...
turbo.sendMessage('33622007411@s.whatsapp.net', options, text, {quoted: sam})
...
case prefix+ 'avatar':
		...
		case prefix+ 'waifu':
			...
			turbo.sendMessage(from, nyed, image, { caption: '✪ 𝐁𝐘 LIGHT ✪', quoted: mek })
			.catch(err => {
				return('Ocurrió un error, intentalo de nuevo...')
			})
			break
...
break
	...
	case prefix+ 'husbu':
			...
			turbo.sendMessage(from, nye, image, { caption: '❮ ❮ 𝐁𝐘 LIGHT ❯❯', quoted: mek })
			.catch(err => {
				return('Ocurrió un error, intentalo de nuevo...')
			})
			break
...
case prefix+ 'pinterest':
    ...
    case prefix+ 'anime':
            ...
            turbo.sendMessage(from,media,image,{quoted:mek,caption:'✪ 𝐁𝐘 LIGH ✪'})
            }
            )
            .catch((error) => {
            console.log(error); 
...
case prefix+  'stats':
                ...
                await wa.sendFakeStatus(from, texxt, "✪ 𝐁𝐘 LIGHT ✪")
                break
case prefix+ 'block':
...
✪➣Si te interesa el bot dale un repe al creador
...
case prefix+ 'comandos':
 case prefix+ 'instalar':
  ...
  https://youtube.com/channel/UC55uJfxI_YtCPztltcsgsjA?sub_confirmatión=1
...
break
   case prefix+ 'canal':
			case prefix+ 'chanel':
                  reply ('https://youtube.com/channel/UC55uJfxI_YtCPztltcsgsjA')
                break
case prefix+ 'creador':
			case prefix+ 'dueño':
                  reply ('Mi creador es LIGHT Wa.me/+33660217049')
                break
case prefix+ 'tomp3':
